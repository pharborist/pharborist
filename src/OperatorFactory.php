...
class OperatorFactory {
  ...
  private static $operators = [
    ...
    T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG => [Operator::ASSOC_LEFT, 10, TRUE, '\Pharborist\Operators\BitwiseAndNode', NULL],
    T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG => [Operator::ASSOC_LEFT, 10, TRUE, '\Pharborist\Operators\BitwiseAndNode', NULL],
